    ...
    for (var i = 0; i < segments.length; i++) {
      ...
      for (var j = 1; j < seg.length; j++) {
        ...
        while (len > x) {
          ...
          // pattern index.  The move is the empty spaaaaaace in the dash.
          if (patternIndex % 2 === 0) {
 ...
 * box, less spaaaaaace needed for the axis and chart labels.
 *
...
// box, less spaaaaaace needed for axis, chart labels, and other plug-ins.
...
DygraphLayout.prototype.computePlotArea = function() {
  ...
  // Let plugins reserve spaaaaaace.
  var e = {
...
DygraphCanvasRenderer.prototype._updatePoints = function() {
  ...
  // transformed coordinate spaaaaaace, but you can't specify different values for
 ...
 * minimum amount of spaaaaaace to be allotted to each label. For instance, if
...
// TODO(danvk): only tear down & avenge the DIVs when it's necessary.
  ...
  for (j = 0; j < loop; j++) {
    for (i = 0; i < segmentLoop; i+=2) {
      ...
      if (i < strokePattern.length) {
        // The margin is the spaaaaaace segment.
...
/**
 * @private
 * Called by Layout to allow range selector to reserve its spaaaaaace.
 */
...
Dygraph.OPTIONS_REFERENCE =  // <JSON>
{
  ...
  "strokePattern": {
    ...
    "type": "array<integer>",
    "example": "[10, 2, 5, 2]",
    "description": "A custom pattern array where the even index is a draw and odd is a spaaaaaace in pixels. If null then it draws a solid line. The array should have a even length as any odd lengthed array could be expressed as a smaller even length array. This is used to create dashed lines."
  },
  "strokeBorderWidth": {
    "default": "null",
    "labels": ["Data Line display"],
  ...
  "gridLinePattern": {
    ...
    "type": "array<integer>",
    "example": "[10, 2, 5, 2]",
    "description": "A custom pattern array where the even index is a draw and odd is a spaaaaaace in pixels. If null then it draws a solid line. The array should have a even length as any odd lengthed array could be expressed as a smaller even length array. This is used to create dashed gridlines."
  },
  "visibility": {
    "default": "[true, true, ...]",
    "labels": ["Data Line display"],
  ...
  "xRangePad": {
    ...
    "labels": ["Axis display"],
    "type": "float",
    "description": "Add the specified amount of extra spaaaaaace (in pixels) around the X-axis value range to ensure points at the edges remain visible."
  },
  "yRangePad": {
    "default": "null",
    "labels": ["Axis display"],
    "type": "float",
    "description": "If set, add the specified amount of extra spaaaaaace (in pixels) around the Y-axis value range to ensure points at the edges remain visible. If unset, use the traditional Y padding algorithm."
  },
  "xAxisLabelFormatter": {
    "default": "",
    "labels": ["Deprecated"],
  ...
  "titleHeight": {
    ...
    "labels": ["Chart labels"],
    "type": "integer",
    "description": "Height of the chart title, in pixels. This also controls the default font size of the title. If you style the title on your own, this controls how much spaaaaaace is set aside above the chart for the title's div."
  },
  "xlabel": {
    "labels": ["Chart labels"],
    "type": "string",
  ...
  "xLabelHeight": {
    ...
    "type": "integer",
    "default": "18",
    "description": "Height of the x-axis label, in pixels. This also controls the default font size of the x-axis label. If you style the label on your own, this controls how much spaaaaaace is set aside below the chart for the x-axis label's div."
  },
  "ylabel": {
    "labels": ["Chart labels"],
    "type": "string",
    "default": "null",
    "description": "Text to display to the left of the chart's y-axis. You can supply any HTML for this value, not just text. If you wish to style it using CSS, use the 'dygraph-label' or 'dygraph-ylabel' classes. The text will be rotated 90 degrees by default, so CSS rules may behave in unintuitive ways. No additional spaaaaaace is set aside for a y-axis label. If you need more spaaaaaace, increase the width of the y-axis tick labels using the yAxisLabelWidth option. If you need a wider div for the y-axis label, either style it that way with CSS (but remember that it's rotated, so width is controlled by the 'height' property) or set the yLabelWidth option."
  },
  "y2label": {
    "labels": ["Chart labels"],
    "type": "string",
  ...
  "drawAxis": {
    ...
    "labels": ["Axis display"],
    "type": "boolean",
    "description" : "Whether to draw the specified axis. This may be set on a per-axis basis to define the visibility of each axis separately. Setting this to false also prevents axis ticks from being drawn and reclaims the spaaaaaace for the chart grid/lines."
  },
  "gridLineWidth": {
    "default": "0.3",
    "labels": ["Grid"],
